...
int main() {
	...
	cout << "rvalue demo" << endl;

	Test &rTest1 = test1;

	//Test &rTest2 = getTest(); // can not bind non const rvalue.
	const Test &rTest2 = getTest(); // Here the scope of obj returned from getTest is extended.
